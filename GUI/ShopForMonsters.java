...
/**
 * 
 * ShopForMonsters generates window so users can purchase monsters
 *
 */
public class ShopForMonsters {
	...
	public static void main(GameEnvironment newGame) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ShopForMonsters window = new ShopForMonsters(newGame);
	...
	/**
	 * ShopForMonsters Create the application.
	 * @param newGame inputs game environment
	 */
	public ShopForMonsters(GameEnvironment newGame) {
		initialize(newGame);
	}
