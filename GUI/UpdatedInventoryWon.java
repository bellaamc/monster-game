...
/**
 * UpdatedInventoryWon Creates the window to show your updated inventory after winning a battle
 */
public class UpdatedInventoryWon {
	...
	public static void main(GameEnvironment newGame) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdatedInventoryWon window = new UpdatedInventoryWon(newGame);
	...
	/**
	 * UpdatedInventoryWon Create the application.
	 * @param newGame passes the game setup into the window
	 * 
	 */
	public UpdatedInventoryWon(GameEnvironment newGame) {
		initialize(newGame);
	}
	...
	private void initialize(GameEnvironment newGame) {
		...
		continueButton.setBounds(591, 15, 89, 23);
